...
public class Employee {
    ...
    public Employee(Integer id, Integer idDepartment, String name, String email, LocalDate dateOfBirth, String phoneNumber, JobRole jobRole, String address) {
        this.id = id;
