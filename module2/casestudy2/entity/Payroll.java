...
public class Payroll {
    ...
    public Payroll(Integer id, int employeeId, BigDecimal baseSalary, BigDecimal bonus, YearMonth period) {
        this.id = id;
        this.employeeId = employeeId;
        this.baseSalary = baseSalary;
        this.bonus = bonus;
    ...
    public BigDecimal calGrossSalary() {
